...
class modEasyCRM extends DolibarrModules
{
	...
	public function init($options = ''): int
    {
        ...
        $extrafields->addExtraField('opporigin', $langs->transnoentities('OpportunityOrigin'), 'sellist', 100, '', 'projet', 0, 0, '', 'a:1:{s:7:"options";a:1:{s:19:"c_input_reason:code";N;}}', 1, '', 1, '', '', '', 'easycrm.lang');
